...
},{"./EventTypes.js":2,"babel/polyfill":100,"pubsub-js":101}],2:[function(require,module,exports){
"use strict";
...
},{"../Module.js":4,"./DataSourcesEvents.js":10,"babel/polyfill":100,"pubsub-js":101}],10:[function(require,module,exports){
"use strict";
...
},{"../Module.js":4,"babel/polyfill":100}],12:[function(require,module,exports){
// # Browser Example
...
},{"./$":34,"./$.assert":16,"./$.ctx":23,"./$.for-of":27,"./$.iter":33,"./$.iter-define":31,"./$.uid":46}],20:[function(require,module,exports){
...
},{"./$":34,"./$.cof":18,"./$.def":24,"./$.iter":33,"./$.wks":48}],32:[function(require,module,exports){
...
},{"./$":34,"./$.cof":18,"./$.ctx":23,"./$.dom-create":25,"./$.invoke":29}],45:[function(require,module,exports){
module.exports = function(exec){
  try {
    exec();
    return false;
...
},{"./$":34,"./$.wks":48}],48:[function(require,module,exports){
...
},{"./$":34,"./$.def":24,"./$.unscope":47}],51:[function(require,module,exports){
'use strict';
var $       = require('./$')
  , $def    = require('./$.def')
  , toIndex = $.toIndex;
...
},{"./$":34,"./$.ctx":23,"./$.def":24,"./$.iter":33,"./$.iter-call":30,"./$.iter-detect":32}],55:[function(require,module,exports){
var $          = require('./$')
...
setUnscope('values');
setUnscope('entries');
},{"./$":34,"./$.iter":33,"./$.iter-define":31,"./$.uid":46,"./$.unscope":47}],56:[function(require,module,exports){
var $def = require('./$.def');
$def($def.S, 'Array', {
...
},{"./$.def":24}],57:[function(require,module,exports){
...
},{"./$":34,"./$.wks":48}],59:[function(require,module,exports){
'use strict';
var $    = require('./$')
  , NAME = 'name'
  , setDesc = $.setDesc
...
},{"./$":34,"./$.def":24}],64:[function(require,module,exports){
// 19.1.3.1 Object.assign(target, source)
var $def = require('./$.def');
$def($def.S, 'Object', {assign: require('./$.assign')});
},{"./$.assign":17,"./$.def":24}],65:[function(require,module,exports){
...
},{"./$.def":24}],66:[function(require,module,exports){
...
},{"./$":34,"./$.def":24}],68:[function(require,module,exports){
'use strict';
...
},{"./$":34,"./$.cof":18,"./$.replacer":38,"./$.species":40}],72:[function(require,module,exports){
'use strict';
var strong = require('./$.collection-strong');
...
},{"./$.collection":22,"./$.collection-strong":19}],73:[function(require,module,exports){
'use strict';
var $def = require('./$.def')
...
},{"./$.def":24,"./$.string-at":41}],74:[function(require,module,exports){
'use strict';
var $    = require('./$')
  , cof  = require('./$.cof')
  , $def = require('./$.def')
...
},{"./$":34,"./$.cof":18,"./$.def":24}],77:[function(require,module,exports){
var set   = require('./$').set
...
},{"./$":34,"./$.iter":33,"./$.iter-define":31,"./$.string-at":41,"./$.uid":46}],78:[function(require,module,exports){
var $    = require('./$')
  , $def = require('./$.def');
...
},{"./$.def":24,"./$.string-repeat":43}],80:[function(require,module,exports){
'use strict';
var $    = require('./$')
  , cof  = require('./$.cof')
  , $def = require('./$.def');
...
},{"./$":34,"./$.collection":22,"./$.collection-weak":21}],83:[function(require,module,exports){
'use strict';
...
},{"./$.collection":22,"./$.collection-weak":21}],84:[function(require,module,exports){
...
},{"./$.array-includes":14,"./$.def":24,"./$.unscope":47}],85:[function(require,module,exports){
// https://github.com/DavidBruant/Map-Set.prototype.toJSON
require('./$.collection-to-json')('Map');
},{"./$.collection-to-json":20}],86:[function(require,module,exports){
...
},{"./$":34,"./$.def":24,"./$.own-keys":36}],87:[function(require,module,exports){
// http://goo.gl/XkBrjD
var $    = require('./$')
  , $def = require('./$.def');
...
},{"./$":34,"./$.def":24}],88:[function(require,module,exports){
// https://gist.github.com/kangax/9698100
var $def = require('./$.def');
$def($def.S, 'RegExp', {
  escape: require('./$.replacer')(/([\\\-[\]{}()*+?.,^$|])/g, '\\$1', true)
});
},{"./$.def":24,"./$.replacer":38}],89:[function(require,module,exports){
// https://github.com/DavidBruant/Map-Set.prototype.toJSON
require('./$.collection-to-json')('Set');
},{"./$.collection-to-json":20}],90:[function(require,module,exports){
...
},{"./$.def":24,"./$.string-pad":42}],93:[function(require,module,exports){
...
},{"./$":34,"./$.ctx":23,"./$.def":24}],94:[function(require,module,exports){
...
},{"./$":34,"./$.iter":33,"./$.wks":48,"./es6.array.iterator":55}],95:[function(require,module,exports){
var $def  = require('./$.def')
  , $task = require('./$.task');
$def($def.G + $def.B, {
...
},{"./$.def":24,"./$.task":44}],96:[function(require,module,exports){
...
},{"./lib/babel/polyfill":13}],100:[function(require,module,exports){
